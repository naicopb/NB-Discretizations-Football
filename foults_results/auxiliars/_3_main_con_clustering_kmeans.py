    ...
    for temporada in temporadas:
        ...
        for i in range(0, len(historical)):
            if historical[i]['temporada'] == temporada:
                ...
                node1_HomeTeam = asignaNodoFaltas(historical[i]['HomeTeam'], equipos_con_faltas_recibidas, 'recibidas')
                node1_AwayTeam = asignaNodoFaltas(historical[i]['AwayTeam'], equipos_con_faltas_efectuadas, 'efectuadas')
                #print(node1_HomeTeam)
                #print(node1_AwayTeam)
                node2_HomeTeam = asignaNodoFaltas(historical[i]['HomeTeam'], equipos_con_faltas_efectuadas, 'recibidas')
                node2_AwayTeam = asignaNodoFaltas(historical[i]['AwayTeam'], equipos_con_faltas_recibidas, 'efectuadas')
...
def calculaProbabilidad(extremoInferior, extremoSuperior, node1_home, node1_away, node2_home, node2_away, array_node_1, array_node_2, arrayTotal):
    ...
    for i in range(0, len(array_node_1)):
        if array_node_1[i]['elemento1'] == node1_home and array_node_1[i]['elemento2'] == node1_away:
            node1Favor, node1Contra = discriminaCantidades(array_node_1[i]['cantidad'], extremoInferior, extremoSuperior)
    for i in range(0, len(array_node_2)):
        if array_node_2[i]['elemento1'] == node2_home and array_node_2[i]['elemento2'] == node2_away:
            node2Favor, node2Contra = discriminaCantidades(array_node_2[i]['cantidad'], extremoInferior, extremoSuperior)
    #print('----------')
    #print(totalesFavor)
    #print(totalesContra)
    #print(node1Favor)
...
def asignaNodoFaltas(equipo, listado, accion):
    arrayClasificacion = []
    ...
    return asignaNodoPorPosicion(equipo, arrayClasificacion, accion)

def asignaNodoPorPosicion(equipo, array, accion):
    if accion == 'recibidas':
        if array[0]['equipo'] == equipo:
            return 0
        if array[1]['equipo'] == equipo:
            return 0
        if array[2]['equipo'] == equipo:
            return 1
        if array[3]['equipo'] == equipo:
            return 1
        if array[4]['equipo'] == equipo:
            return 1
        if array[5]['equipo'] == equipo:
            return 1
        if array[6]['equipo'] == equipo:
            return 1
        if array[7]['equipo'] == equipo:
            return 2
        if array[8]['equipo'] == equipo:
            return 2
        if array[9]['equipo'] == equipo:
            return 2
        if array[10]['equipo'] == equipo:
            return 2
        if array[11]['equipo'] == equipo:
            return 2
        if array[12]['equipo'] == equipo:
            return 2
        if array[13]['equipo'] == equipo:
            return 2
        if array[14]['equipo'] == equipo:
            return 2
        if array[15]['equipo'] == equipo:
            return 2
        if array[16]['equipo'] == equipo:
            return 3
        if array[17]['equipo'] == equipo:
            return 3
        if array[18]['equipo'] == equipo:
            return 3
        if array[19]['equipo'] == equipo:
            return 4
    if accion == 'efectuadas':
        if array[0]['equipo'] == equipo:
            return 0
        if array[1]['equipo'] == equipo:
            return 0
